...
namespace Holorama.Application
{
    ...
    {
        private SynthesisOptimizer synthesisOptimizer;
        private IGenerator holoramaGenerator;

        private double bestScore = 1e12;
        private bool improved = false;

        public MainWindow(SynthesisOptimizer optimizer, IGenerator holoramaGenerator)
        {
            InitializeComponent();
            synthesisOptimizer = optimizer;
            this.holoramaGenerator = holoramaGenerator;
        ...
        {
            var bitmap = holoramaGenerator.GenerateBitmap(new Size(1920 * 2, 1280 * 2), new RectangleF(10, 10, (float) (19.2) , (float) (12.8)), new GeneratorOptions("Sahara"));

...
namespace Holorama.Logic.Concrete.Generators
{
    ...
    {
        private IFactory<ISpaceDivision, RectangleF, SpaceDivisionOptions> divisor;
        ...
        {
            var division = divisor.Create(area, null);
            var lightPen = new Pen(Color.Gray, 0.01f);
        ...
        public BasicExperimentalGenerator(IFactory<ISpaceDivision, RectangleF, SpaceDivisionOptions> divisor)
        {
